...
<body style="background-image:url(Admin/p4.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/userback.jpg" width="40px" height="40px"><strong> Doctor's World </strong>Appointment Booking System</a></li>
