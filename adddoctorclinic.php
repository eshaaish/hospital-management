...
<ul>
<li class="dropdown"><font color="red" size="10">ADD DOCTOR TO A CLINIC</font></li>
<br>
<h2>
  <li class="dropdown">    
  ...
  <a href="javascript:void(0)" class="dropbtn">Clinic</a>
    <div class="dropdown-content">
      ...
      <a href="adddoctorclinic.php">Assign a Doctor to Clinic</a>
	  <a href="addmanagerclinic.php">Assign a Manager to Clinic</a>
...
<label style="font-size:20px" >City:</label>
		...
		Days on which doctor is available<br>
		<table>
